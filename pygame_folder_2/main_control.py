...
while True:
    ...
    if stage == "stage2":
        stage = stage2.stage_status(screen)
    if stage == "stage3":
        stage = stage3.stage_status(screen)
    if stage == "stage4":
        stage = stage4.stage_status(screen)
    if stage == "stage5":
        stage = stage5.stage_status(screen)
    if stage == "stage6":
        stage = stage6.stage_status(screen)
