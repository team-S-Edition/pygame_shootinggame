...
def stage_status(screen):
    ...
    enemy01_x,enemy01_y= width // 2, height/2 
    ui_x,ui_y = width,0
    speed = 5
    low_speed = 2
    enemy_speed = 2
    ...
    enemy_bombs_speed = 10
    shot_delay_enemy = 200
    ...
    # テキスト
    text_stage4=font_stage1.render("ステージ4", True, (255, 255, 255))
    text_stage4_english =font_impact3.render("Stage4", True, (255, 255, 255))
...
#当たり判定制御--------------------------------------------------------------------------------------------------------------
        ...
        if enemy_arrive==True:
            for x,y in enemy_bombs01:
                y+= enemy_bombs_speed * math.sin(angle_rad) * 4
